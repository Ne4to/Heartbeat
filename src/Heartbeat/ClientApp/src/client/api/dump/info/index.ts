...
import { createDumpInfoFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, deserializeIntoProblemDetails, serializeProblemDetails, type DumpInfo, type ProblemDetails } from '../../../models/';
import { BaseRequestBuilder, HttpMethod, RequestInformation, type Parsable, type ParsableFactory, type RequestAdapter, type RequestConfiguration, type RequestOption } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/dump/info
 */
export class InfoRequestBuilder extends BaseRequestBuilder<InfoRequestBuilder> {
    /**
     ...
     */
    public get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<DumpInfo | undefined> {
