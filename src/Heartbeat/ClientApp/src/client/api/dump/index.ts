...
import { ArraysRequestBuilder } from './arrays/';
import { HeapDumpStatisticsRequestBuilder } from './heapDumpStatistics/';
import { HttpRequestsRequestBuilder } from './httpRequests/';
...
export class DumpRequestBuilder extends BaseRequestBuilder<DumpRequestBuilder> {
     ...
     * The arrays property
     */
    public get arrays(): ArraysRequestBuilder {
        return new ArraysRequestBuilder(this.pathParameters, this.requestAdapter);
    }
    /**
    ...
    /**
     * The httpRequests property
     */
    public get httpRequests(): HttpRequestsRequestBuilder {
        return new HttpRequestsRequestBuilder(this.pathParameters, this.requestAdapter);
    }
    /**
     * The info property
     */
