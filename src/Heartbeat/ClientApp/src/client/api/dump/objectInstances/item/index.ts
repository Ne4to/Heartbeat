...
import { createGetObjectInstancesResultFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, deserializeIntoProblemDetails, Generation, serializeProblemDetails, TraversingHeapModes, type GetObjectInstancesResult, type ProblemDetails } from '../../../../models/';
...
export class WithMtItemRequestBuilder extends BaseRequestBuilder<WithMtItemRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/api/dump/object-instances/{mt}{?traversingMode*,generation*}", (x, y) => new WithMtItemRequestBuilder(x, y));
    }
    /**
