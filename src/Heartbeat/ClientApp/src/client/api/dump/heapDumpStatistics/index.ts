...
import { createObjectTypeStatisticsFromDiscriminatorValue, Generation, TraversingHeapModes, type ObjectTypeStatistics } from '../../../models/';
...
export class HeapDumpStatisticsRequestBuilder extends BaseRequestBuilder<HeapDumpStatisticsRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/api/dump/heap-dump-statistics{?traversingMode*,generation*}", (x, y) => new HeapDumpStatisticsRequestBuilder(x, y));
    }
    /**
